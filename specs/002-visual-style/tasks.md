...
- [x] T002 Add `frontend/public/favicon.ico` and sample PNGs at `frontend/public/favicon-32.png` and `frontend/public/favicon-16.png` and link them in `frontend/src/index.html`
...
- [x] T005 Verify color contrast for text using the variables in `frontend/src/styles.css` and document results in `specs/002-visual-style/qa.md`
...
- [x] T009 [P] Generate favicon files `frontend/public/favicon-32.png`, `frontend/public/favicon-16.png`, and `frontend/public/favicon.ico` from `frontend/src/assets/pichub-logo.svg`
- [x] T010 [P] Add inverted/mono logo variants at `frontend/src/assets/pichub-logo-inverted.svg` and `frontend/src/assets/pichub-logo-mono.svg`

Phase 5: QA & Docs

- [x] T011 Create `specs/002-visual-style/quickstart.md` with logo usage, spacing rules, and token list (colors and fonts)
